...
def test_sep0005():
    ...
    address = Keypair.deterministic(mnemonic, index=6).address_str
    ...
    address = Keypair.deterministic(mnemonic, passphrase='p4ssphr4se', index=9).address_str
    ...
    address = Keypair.deterministic(mnemonic, index=8).address_str
